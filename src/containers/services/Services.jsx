...
function Services() {
    return (
        ...
        <div className='services-container'>
            <Service icon={DigitalMarketing} title='Interior Architect' text='I work with certain design tools to create high-fidelity designs and prototypes. I design accessible and usable products which aid business growth.' />
            ...
            <Service icon={AppDev} title='Ui/Ux Design ' text='I develop responsive, stunning web-apps using modern technologies like React.js.'  />
        </div>
